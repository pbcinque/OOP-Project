...
public class ReceiptController implements Initializable {
    ...
    price1, price11, price111, price2, price22, price222, 
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (HomeController.fruit.getProductStatus()) {
            ...
            amount4.setText(Double
                    .toString(HomeController.fruit.getProductPrice() * HomeController.fruit.getProductQuantity()));
        ...
        if (HomeController.matcha.getProductStatus()) {
            ...
            item6Amount = HomeController.matcha.getProductPrice() * HomeController.matcha.getProductQuantity();
